...
const Snackbar = ({ visible, message, type = 'success', onHide }) => {
  ...
  const backgroundColor = type === 'success' ? '#00D1B2' : type === 'error' ? '#EF4444' : '#6366F1';
          ...
          <View style={styles.notificationDetail}>
            ...
            <View style={styles.detailActions}>
              <TouchableOpacity style={styles.actionButton}>
                <Feather name="share-2" size={18} color="#00D1B2" />
                <Text style={styles.actionButtonText}>Share</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.actionButton}>
                <Feather name="bookmark" size={18} color="#00D1B2" />
...
const INITIAL_NOTIFICATIONS = [
  {
    id: '1',
    title: 'Your Weekly Carbon Report is Ready! 📊',
    body: 'Check the Insights tab for detailed emissions analysis and recommendations. This comprehensive report includes your weekly carbon footprint, reduction suggestions, and progress tracking.',
    time: '2 mins ago',
    type: 'report',
    pinned: false,
    read: false,
  ...
  {
    id: '2',
    title: 'New Feature: Live Chat with Analysts 💬',
    body: 'Connect instantly with our carbon experts for personalized guidance. Get real-time answers to your sustainability questions.',
    time: '1 hour ago',
    type: 'feature',
    pinned: false,
    read: false,
  },
  {
    ...
    body: 'You\'ve successfully reduced emissions by 15% this quarter. Keep up the excellent work towards your sustainability goals!',
    time: '3 hours ago',
    type: 'achievement',
    pinned: true,
    read: true,
  },
  {
    ...
    body: 'Brief downtime on Sunday 2:00-3:00 AM UTC for system improvements. We apologize for any inconvenience.',
    time: 'Yesterday',
    type: 'info',
    pinned: false,
    read: true,
  },
  {
    ...
    body: 'Your latest emission data has been successfully synchronized with our servers. All your data is up to date.',
    time: '2 days ago',
    type: 'success',
    pinned: false,
    read: true,
...
const notificationTypeConfig = {
  report: { icon: 'bar-chart-2', color: '#00D1B2' },
  feature: { icon: 'star', color: '#6366f1' },
      ...
      >
        ...
        >
          <TouchableOpacity activeOpacity={0.8} onPress={() => onPress(item)}>
            <LinearGradient
              colors={item.pinned ? ['#f0fdfa', '#ffffff'] : ['#ffffff', '#fafafa']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
                ...
                <View style={styles.headerRow}>
                  ...
                  {item.pinned && (
                    <View style={styles.pinnedBadge}>
                      <Feather name="bookmark" size={12} color="#00D1B2" />
                    </View>
                  )}
                </View>
